                ...
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="text-lg leading-7 font-semibold text-center block" style="width: 100%">
                            <a target="_blank" href="https://github.com/CGIS-2024/proyecto-evaluacion-continua-gruporp" class="underline text-gray-900 dark:text-white">Proyecto Gestión negocio Farmaceútico</a>
                        </div>
                    </div>
